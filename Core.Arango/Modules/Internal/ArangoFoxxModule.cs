...
namespace Core.Arango.Modules.Internal
{
    internal class ArangoFoxxModule : ArangoModule, IArangoFoxxModule
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var res = await Context.Configuration.Transport.SendContentAsync(Netstandard20Helper.Patch,
                ApiPath(database, "foxx/service", parameter), PackService(service),
                cancellationToken: cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await SendAsync<ArangoVoid>(database, Netstandard20Helper.Patch,
